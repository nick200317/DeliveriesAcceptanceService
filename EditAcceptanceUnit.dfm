object EditAcceptanceForm: TEditAcceptanceForm
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'EditAcceptanceForm'
  ClientHeight = 342
  ClientWidth = 408
  Color = clWhite
  ...
  OnShow = FormShow
  TextHeight = 22
  object lblEditAcceptance: TLabel
    Left = 16
    Top = 16
    Width = 369
    Height = 32
  ...
  object btnEditAcceptance: TButton
    Left = 16
    Top = 297
    Width = 369
    Height = 30
    ...
    Default = True
    TabOrder = 2
    OnClick = btnEditAcceptanceClick
  end
