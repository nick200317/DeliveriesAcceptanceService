object AddAcceptanceItemForm: TAddAcceptanceItemForm
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'AddAcceptanceItemForm'
  ClientHeight = 269
  ClientWidth = 408
  Color = clWhite
  ...
  OnShow = FormShow
  TextHeight = 22
  object lblAddAcceptanceItem: TLabel
    Left = 16
    Top = 16
    Width = 369
    Height = 32
  ...
  object btnAddAcceptanceItem: TButton
    Left = 16
    Top = 224
    Width = 369
    Height = 30
    ...
    Default = True
    TabOrder = 2
    OnClick = btnAddAcceptanceItemClick
  end
